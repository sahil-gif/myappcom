...
function initializeVeiwReportDiabetiesNegative(){
    ...
    diabetiesVeiwReport.position(900,900);
}
function initializeVeiwReportCovid19Negative(){
    ...
    Covid19VeiwReport.position(900,900);
}
